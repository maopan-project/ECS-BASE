    ...
    execute: function () {
      ...
      _export("GameStart", GameStart = (_dec = property(Label), ccclass(_class = (_class2 = class GameStart extends Component {
        ...
        addPlayer(uid) {
          ...
          let trans = player.getComponent(_crd && TransformComponent === void 0 ? (_reportPossibleCrUseOfTransformComponent({
            error: Error()
...
//# sourceMappingURL=b5a6ae844a614fb5db9a0797287c043529456f94.js.map