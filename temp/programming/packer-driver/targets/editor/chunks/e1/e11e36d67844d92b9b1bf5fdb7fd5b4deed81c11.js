      ...
      _export("MoveSystem", MoveSystem = class MoveSystem {
        ...
        onUpdate() {
          ...
          this.world.forEach([_crd && MoveComponent === void 0 ? (_reportPossibleCrUseOfMoveComponent({
            ...
            transform.position.add(move.moveSpeed); // transform.angle = move.moveSpeed.x > 0 ? 0 : (move.moveSpeed.x < 0 ? 180 : transform.angle);
          });
        }
...
//# sourceMappingURL=e11e36d67844d92b9b1bf5fdb7fd5b4deed81c11.js.map