          ...
          if (msgOp.msgThisLogic) {
            ...
            for (let i = 0; i < operations.length; i++) {
              ...
              if (entity) {
                ...
                console.log('aaaaaaa', entity.getComponent(_crd && MoveComponent === void 0 ? (_reportPossibleCrUseOfMoveComponent({
                  error: Error()
                }), MoveComponent) : MoveComponent).moveSpeed);
              }
            }
          }
...
//# sourceMappingURL=c3745910a184e4d77497f9b51ac308115a84b31c.js.map