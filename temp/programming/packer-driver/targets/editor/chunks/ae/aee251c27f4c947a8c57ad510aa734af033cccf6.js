System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13", "__unresolved_14"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Input, input, KeyCode, Label, ActorStatusComponent, CampComponent, CollisionComponent, FireComponent, MoveComponent, NetworkReceiveComponent, TransformComponent, EntityType, World, GameService, EventCenter, Vector3, GameMessageC2S_GameStart, GameMessageC2S_Operation, GameMessageType, MessagePool, WSClient, _dec, _class, _class2, _descriptor, _crd, ccclass, property, GameStart;
  ...
  function _reportPossibleCrUseOfActorStatusComponent(extras) {
    _reporterNs.report("ActorStatusComponent", "./ecs/components/ActorStatusComponent", _context.meta, extras);
  }

  function _reportPossibleCrUseOfCampComponent(extras) {
    _reporterNs.report("CampComponent", "./ecs/components/CampComponent", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      CampComponent = _unresolved_3.default;
    }, function (_unresolved_4) {
      CollisionComponent = _unresolved_4.default;
    }, function (_unresolved_5) {
      FireComponent = _unresolved_5.default;
    }, function (_unresolved_6) {
      MoveComponent = _unresolved_6.default;
    }, function (_unresolved_7) {
      NetworkReceiveComponent = _unresolved_7.default;
    }, function (_unresolved_8) {
      TransformComponent = _unresolved_8.default;
    }, function (_unresolved_9) {
      EntityType = _unresolved_9.EntityType;
    }, function (_unresolved_10) {
      World = _unresolved_10.default;
    }, function (_unresolved_11) {
      GameService = _unresolved_11.default;
    }, function (_unresolved_12) {
      EventCenter = _unresolved_12.EventCenter;
    }, function (_unresolved_13) {
      Vector3 = _unresolved_13.Vector3;
    }, function (_unresolved_14) {
      GameMessageC2S_GameStart = _unresolved_14.GameMessageC2S_GameStart;
      GameMessageC2S_Operation = _unresolved_14.GameMessageC2S_Operation;
      GameMessageType = _unresolved_14.GameMessageType;
      MessagePool = _unresolved_14.MessagePool;
    }, function (_unresolved_15) {
      WSClient = _unresolved_15.WSClient;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("GameStart", GameStart = (_dec = property(Label), ccclass(_class = (_class2 = class GameStart extends Component {
        ...
        sendOp() {
          ...
          if (this.lastDir.x != x || this.lastDir.y != y || isFire != this.lastIsFire) {
            ...
            let msg = (_crd && MessagePool === void 0 ? (_reportPossibleCrUseOfMessagePool({
              error: Error()
        ...
        onGetOperations(msg) {
          let nrc = (_crd && World === void 0 ? (_reportPossibleCrUseOfWorld({
            error: Error()
        ...
        addPlayer(uid, campID) {
          console.log('add player', uid);
          let player = (_crd && World === void 0 ? (_reportPossibleCrUseOfWorld({
            error: Error()
          }), World) : World).instance.getNewEntity((_crd && EntityType === void 0 ? (_reportPossibleCrUseOfEntityType({
            error: Error()
          }), EntityType) : EntityType).Actor);
          let trans = player.addComponent(_crd && TransformComponent === void 0 ? (_reportPossibleCrUseOfTransformComponent({
            error: Error()
          }), TransformComponent) : TransformComponent);
          let move = player.addComponent(_crd && MoveComponent === void 0 ? (_reportPossibleCrUseOfMoveComponent({
            error: Error()
          }), MoveComponent) : MoveComponent);
          let fire = player.addComponent(_crd && FireComponent === void 0 ? (_reportPossibleCrUseOfFireComponent({
            error: Error()
          }), FireComponent) : FireComponent);
          let collision = player.addComponent(_crd && CollisionComponent === void 0 ? (_reportPossibleCrUseOfCollisionComponent({
            error: Error()
          }), CollisionComponent) : CollisionComponent);
          let actorStatus = player.addComponent(_crd && ActorStatusComponent === void 0 ? (_reportPossibleCrUseOfActorStatusComponent({
            error: Error()
          }), ActorStatusComponent) : ActorStatusComponent);
          let camp = player.addComponent(_crd && CampComponent === void 0 ? (_reportPossibleCrUseOfCampComponent({
            error: Error()
...
//# sourceMappingURL=aee251c27f4c947a8c57ad510aa734af033cccf6.js.map