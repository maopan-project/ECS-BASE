System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Input, input, instantiate, KeyCode, Label, Prefab, Square, EventCenter, GameMessageC2S_Operation, GameMessageType, MessagePool, WSClient, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, GameStart;
  ...
  function _reportPossibleCrUseOfGameMessageS2C_GameStart(extras) {
    _reporterNs.report("GameMessageS2C_GameStart", "./GameMessageBase", _context.meta, extras);
  }

  function _reportPossibleCrUseOfGameMessageS2C_Operations(extras) {
    _reporterNs.report("GameMessageS2C_Operations", "./GameMessageBase", _context.meta, extras);
  }

  function _reportPossibleCrUseOfGameMessageS2C_UID(extras) {
    _reporterNs.report("GameMessageS2C_UID", "./GameMessageBase", _context.meta, extras);
  }

  function _reportPossibleCrUseOfGameMessageType(extras) {
    _reporterNs.report("GameMessageType", "./GameMessageBase", _context.meta, extras);
  }

  function _reportPossibleCrUseOfMessagePool(extras) {
    _reporterNs.report("MessagePool", "./GameMessageBase", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameStart", GameStart = (_dec = ccclass('GameStart'), _dec2 = property(Prefab), _dec3 = property(Label), _dec(_class = (_class2 = class GameStart extends Component {
        ...
        addPlayer(uid) {
          let square = instantiate(this.squarePrefab).getComponent(_crd && Square === void 0 ? (_reportPossibleCrUseOfSquare({
            error: Error()
          }), Square) : Square);
...
//# sourceMappingURL=f3cc324718b13d2ac42cae8f5e90cec8862b88ce.js.map