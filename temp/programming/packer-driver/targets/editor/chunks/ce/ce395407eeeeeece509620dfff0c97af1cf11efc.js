System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Input, input, KeyCode, Label, MoveComponent, NetworkReceiveComponent, TransformComponent, EntityType, World, GameService, EventCenter, Vector3, GameMessageC2S_GameStart, GameMessageC2S_Operation, GameMessageType, MessagePool, WSClient, FireComponent, _dec, _class, _class2, _descriptor, _crd, ccclass, property, GameStart;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      EntityType = _unresolved_5.EntityType;
    }, function (_unresolved_6) {
      World = _unresolved_6.default;
    }, function (_unresolved_7) {
      GameService = _unresolved_7.default;
    }, function (_unresolved_8) {
      EventCenter = _unresolved_8.EventCenter;
    }, function (_unresolved_9) {
      Vector3 = _unresolved_9.Vector3;
    }, function (_unresolved_10) {
      GameMessageC2S_GameStart = _unresolved_10.GameMessageC2S_GameStart;
      GameMessageC2S_Operation = _unresolved_10.GameMessageC2S_Operation;
      GameMessageType = _unresolved_10.GameMessageType;
      MessagePool = _unresolved_10.MessagePool;
    }, function (_unresolved_11) {
      WSClient = _unresolved_11.WSClient;
    }, function (_unresolved_12) {
      FireComponent = _unresolved_12.default;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("GameStart", GameStart = (_dec = property(Label), ccclass(_class = (_class2 = class GameStart extends Component {
        ...
        addPlayer(uid) {
          ...
          player.addComponent(_crd && MoveComponent === void 0 ? (_reportPossibleCrUseOfMoveComponent({
            error: Error()
          }), MoveComponent) : MoveComponent);
          player.addComponent(_crd && TransformComponent === void 0 ? (_reportPossibleCrUseOfTransformComponent({
            error: Error()
          }), TransformComponent) : TransformComponent);
          player.addComponent(_crd && FireComponent === void 0 ? (_reportPossibleCrUseOfFireComponent({
            error: Error()
...
//# sourceMappingURL=ce395407eeeeeece509620dfff0c97af1cf11efc.js.map