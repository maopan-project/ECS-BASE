System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Input, input, KeyCode, Prefab, Vector3, GameMessageC2S_Operation, GameMessageOperationBody, WSClient, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, GameStart;
  ...
  function _reportPossibleCrUseOfGameMessageC2S_Operation(extras) {
    _reporterNs.report("GameMessageC2S_Operation", "./GameMessageBase", _context.meta, extras);
  }

  function _reportPossibleCrUseOfGameMessageOperationBody(extras) {
    _reporterNs.report("GameMessageOperationBody", "./GameMessageBase", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      GameMessageOperationBody = _unresolved_3.GameMessageOperationBody;
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'EventKeyboard', 'Input', 'input', 'KeyCode', 'Prefab']);
      ...
      _export("GameStart", GameStart = (_dec = ccclass('GameStart'), _dec2 = property(Prefab), _dec(_class = (_class2 = class GameStart extends Component {
        ...
        update(deltaTime) {
          let v3 = new (_crd && Vector3 === void 0 ? (_reportPossibleCrUseOfVector({
            error: Error()
          }), Vector3) : Vector3)();
          if (this._keyMap.get(KeyCode.KEY_A)) v3.x -= 1;
          if (this._keyMap.get(KeyCode.KEY_S)) v3.y -= 1;
          if (this._keyMap.get(KeyCode.KEY_D)) v3.x += 1;
          if (this._keyMap.get(KeyCode.KEY_W)) v3.x += 1;
          let body = new (_crd && GameMessageOperationBody === void 0 ? (_reportPossibleCrUseOfGameMessageOperationBody({
            error: Error()
          }), GameMessageOperationBody) : GameMessageOperationBody)();
          body.dir = v3;
          let msg = new (_crd && GameMessageC2S_Operation === void 0 ? (_reportPossibleCrUseOfGameMessageC2S_Operation({
            error: Error()
...
//# sourceMappingURL=efa9d10254fd6ced0a7decc02b64e0752d00b7d8.js.map