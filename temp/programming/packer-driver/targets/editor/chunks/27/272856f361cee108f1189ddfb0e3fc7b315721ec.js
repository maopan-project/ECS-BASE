System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, Component, Prefab, _decorator, SystemType, EntityType, World, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, RenderSystem;
        ...
        onUpdate() {
          ...
          for (let i = 0; i < entities.length; i++) {
            ...
            if (entity.type === (_crd && EntityType === void 0 ? (_reportPossibleCrUseOfEntityType({
              error: Error()
            }), EntityType) : EntityType).Actor) {// let arrow = instantiate(this.PrefabArrow).getComponent(EntityType.Actor);
              // arrow.entity = entity;
...
//# sourceMappingURL=272856f361cee108f1189ddfb0e3fc7b315721ec.js.map