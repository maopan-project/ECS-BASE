System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, GameTool, BulletComponent, CampComponent, CollisionComponent, FireComponent, MoveComponent, NetworkReceiveComponent, TransformComponent, EntityType, SystemType, FireSystem, _crd;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      EntityType = _unresolved_10.EntityType;
      SystemType = _unresolved_10.SystemType;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("default", FireSystem = class FireSystem {
        ...
        generateBullet(fire, fromEntity) {
          ...
          let camp = entity.addComponent(_crd && CampComponent === void 0 ? (_reportPossibleCrUseOfCampComponent({
            error: Error()
          }), CampComponent) : CampComponent);
          let bullet = entity.addComponent(_crd && BulletComponent === void 0 ? (_reportPossibleCrUseOfBulletComponent({
            error: Error()
          }), BulletComponent) : BulletComponent);
          let collision = entity.addComponent(_crd && CollisionComponent === void 0 ? (_reportPossibleCrUseOfCollisionComponent({
            error: Error()
...
//# sourceMappingURL=0fa82c301ba76f74389b87b596db6d61f8feffea.js.map