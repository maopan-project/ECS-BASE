        ...
        onUpdate() {
          ...
          if (msgOp.msgThisLogic) {
            ...
            for (let i = 0; i < operations.length; i++) {
              ...
              if (entity) {
                let moveComp = entity.getComponent(_crd && MoveComponent === void 0 ? (_reportPossibleCrUseOfMoveComponent({
                  error: Error()
                }), MoveComponent) : MoveComponent);
                let transformComp = entity.getComponent(_crd && TransformComponent === void 0 ? (_reportPossibleCrUseOfTransformComponent({
                  error: Error()
...
//# sourceMappingURL=11534c886568a694760674e332c39859e6456e14.js.map