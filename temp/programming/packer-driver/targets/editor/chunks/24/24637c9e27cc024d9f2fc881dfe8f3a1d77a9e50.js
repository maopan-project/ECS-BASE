        ...
        onUpdate() {
          ...
          for (let i = 0; i < entities.length; i++) {
            ...
            if (entity.type === (_crd && EntityType === void 0 ? (_reportPossibleCrUseOfEntityType({
              ...
              let arrow = instantiate(this.PrefabArrow).getComponent(_crd && Arrow === void 0 ? (_reportPossibleCrUseOfArrow({
                error: Error()
              }), Arrow) : Arrow);
              arrow.entity = entity;
...
//# sourceMappingURL=24637c9e27cc024d9f2fc881dfe8f3a1d77a9e50.js.map