System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Input, input, KeyCode, Label, EventCenter, GameMessageC2S_GameStart, GameMessageC2S_Operation, GameMessageType, MessagePool, WSClient, GameService, World, EntityType, TransformComponent, NetworkReceiveComponent, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, GameStart;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'EventKeyboard', 'Input', 'input', 'KeyCode', 'Label', 'Prefab']);
      ...
      _export("GameStart", GameStart = (_dec = ccclass('GameStart'), _dec2 = property(Label), _dec(_class = (_class2 = class GameStart extends Component {
        constructor(...args) {
          super(...args);
      ...
      }, (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "lbUserID", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
...
//# sourceMappingURL=e68679214df0e40324c36c416e357ccdf2451dce.js.map