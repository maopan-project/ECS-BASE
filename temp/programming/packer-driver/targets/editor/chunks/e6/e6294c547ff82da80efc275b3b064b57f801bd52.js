        ...
        onUpdate() {
          this.world.forEach([_crd && CollisionComponent === void 0 ? (_reportPossibleCrUseOfCollisionComponent({
            ...
            for (let i = 0; i < collisionEntities.length; i++) {
              ...
              let otherActorStatus = otherEntity.getComponent(_crd && ActorStatusComponent === void 0 ? (_reportPossibleCrUseOfActorStatusComponent({
                error: Error()
              }), ActorStatusComponent) : ActorStatusComponent);
              let otherCamp = otherEntity.getComponent(_crd && CampComponent === void 0 ? (_reportPossibleCrUseOfCampComponent({
                error: Error()
              }), CampComponent) : CampComponent);

              if (otherActorStatus && otherCamp && otherCamp.camp !== camp.camp) {
                let criticalHit = (_crd && GameTool === void 0 ? (_reportPossibleCrUseOfGameTool({
                  error: Error()
...
//# sourceMappingURL=e6294c547ff82da80efc275b3b064b57f801bd52.js.map