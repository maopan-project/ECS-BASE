    ...
    execute: function () {
      ...
      _export("GameStart", GameStart = (_dec = ccclass('GameStart'), _dec2 = property(Prefab), _dec(_class = (_class2 = class GameStart extends Component {
        ...
        start() {
          ...
          this.squares.set(this.uid, square);
        }
        ...
        update(deltaTime) {
          ...
          if (this._keyMap.get(KeyCode.KEY_W)) v3.x += 1; // let body = new GameMessageOperationBody();
          // body.dir = v3;
          ...
          this.squares.get(this.uid).move(v3);
        }
...
//# sourceMappingURL=393e58d3a5c4a934161ab23bf747cd028ff6630c.js.map