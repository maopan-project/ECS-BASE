    ...
    execute: function () {
      ...
      _export("default", GameService = class GameService {
        ...
        static logicCycleThisCycle() {
          ...
          let logicThisCycle = Math.min(maxLogicNet, maxLogicTime) - world.logicCycleCount; // log('可以执行的逻辑帧是-', logicThisCycle, '最大的时间值-', maxLogicTime, '最大的网络值-', maxLogicNet);
...
//# sourceMappingURL=035b35436980b4852a1cb8c3e183f35d00872e0e.js.map