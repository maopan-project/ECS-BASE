  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", World = class World {
        constructor() {
          this.allEntities = new Array(1024);
        ...
        addEntityToWorld(entity) {
          this.useEntityID = ++this.useEntityID % 1024;
        ...
        removeDestroyedEntities() {
          for (var i = 0; i < this.entitiesDestroyInThisCycle.length; i++) {
            ...
            this.allEntities[_entity3.id - 1] = null;
          }
...
//# sourceMappingURL=8990cbc5e964fb0ddb8a0b63e863513994bd2731.js.map