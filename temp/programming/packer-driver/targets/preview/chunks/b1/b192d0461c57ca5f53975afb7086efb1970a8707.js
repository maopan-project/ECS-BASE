System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Sprite, SpriteFrame, v3, Vec3, FireComponent, MoveComponent, TransformComponent, World, GameActorMachine, GameActorFire, GameActorIdle, GameActorWalk, StateType, GameUIBase, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, GameActor;
  ...
  function _reportPossibleCrUseOfGameActorFire(extras) {
    _reporterNs.report("GameActorFire", "../state-machine/GameActorState", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      TransformComponent = _unresolved_4.default;
    }, function (_unresolved_5) {
      World = _unresolved_5.default;
    }, function (_unresolved_6) {
      GameActorMachine = _unresolved_6.default;
    }, function (_unresolved_7) {
      GameActorFire = _unresolved_7.GameActorFire;
      GameActorIdle = _unresolved_7.GameActorIdle;
      GameActorWalk = _unresolved_7.GameActorWalk;
      StateType = _unresolved_7.StateType;
    }, function (_unresolved_8) {
      GameUIBase = _unresolved_8.default;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("GameActor", GameActor = (_dec = property(Sprite), _dec2 = property([SpriteFrame]), _dec3 = property([SpriteFrame]), _dec4 = property([SpriteFrame]), ccclass(_class = (_class2 = class GameActor extends (_crd && GameUIBase === void 0 ? (_reportPossibleCrUseOfGameUIBase({
        error: Error()
        ...
        constructor() {
          ...
          _initializerDefineProperty(this, "sfFire", _descriptor4, this);
        ...
        start() {
          ...
          this.fireComp = this.entity.getComponent(_crd && FireComponent === void 0 ? (_reportPossibleCrUseOfFireComponent({
            error: Error()
        ...
        onUpdate(deltaTime) {
          ...
          var isFire = this.checkIsFire();

          if (isFire && this.machine.state.type !== (_crd && StateType === void 0 ? (_reportPossibleCrUseOfStateType({
            error: Error()
          }), StateType) : StateType).FIRE) {
            this.machine.changeState(new (_crd && GameActorFire === void 0 ? (_reportPossibleCrUseOfGameActorFire({
              error: Error()
            }), GameActorFire) : GameActorFire)());
          } else if (!isFire && isMove && this.machine.state.type != (_crd && StateType === void 0 ? (_reportPossibleCrUseOfStateType({
            error: Error()
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "sfFire", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=b192d0461c57ca5f53975afb7086efb1970a8707.js.map