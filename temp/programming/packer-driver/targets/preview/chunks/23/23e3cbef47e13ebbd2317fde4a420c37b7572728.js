  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameStart", GameStart = (_dec = ccclass('GameStart'), _dec2 = property(Prefab), _dec(_class = (_class2 = class GameStart extends Component {
        ...
        update(deltaTime) {
          var v3 = new (_crd && Vector3 === void 0 ? (_reportPossibleCrUseOfVector({
            error: Error()
          }), Vector3) : Vector3)();
          ...
          var body = new (_crd && GameMessageOperationBody === void 0 ? (_reportPossibleCrUseOfGameMessageOperationBody({
            error: Error()
          }), GameMessageOperationBody) : GameMessageOperationBody)();
          body.dir = v3;
          var msg = new (_crd && GameMessageC2S_Operation === void 0 ? (_reportPossibleCrUseOfGameMessageC2S_Operation({
            error: Error()
...
//# sourceMappingURL=23e3cbef47e13ebbd2317fde4a420c37b7572728.js.map