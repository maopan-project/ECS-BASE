    ...
    execute: function () {
      ...
      _export("GameActorFire", GameActorFire = class GameActorFire extends GameActorStateBase {
        ...
        onuUpdate(deltaTime) {
          super.onuUpdate(deltaTime);
          var actor = this.machine.actor;
          var percent = this.machine.actor.fireComp.currentFrame / this.machine.actor.fireComp.totalFireFrame % 1;
          (_crd && GameTool === void 0 ? (_reportPossibleCrUseOfGameTool({
            error: Error()
...
//# sourceMappingURL=90805c2df92d65dbda9244a3cd47f5088e868444.js.map