        ...
        onUpdate() {
          ...
          for (var i = 0; i < entities.length; i++) {
            ...
            if (entity.type === (_crd && EntityType === void 0 ? (_reportPossibleCrUseOfEntityType({
              ...
              var actor = instantiate(this.PrefabActor).getComponent(_crd && Actor === void 0 ? (_reportPossibleCrUseOfActor({
                error: Error()
              }), Actor) : Actor);
              actor.entity = entity;
...
//# sourceMappingURL=b4498b1fcf36b1a01b44168096cfcbc17ff6cb9a.js.map