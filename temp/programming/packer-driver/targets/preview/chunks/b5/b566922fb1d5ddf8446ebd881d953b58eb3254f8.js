    ...
    execute: function () {
      ...
      _export("GameStart", GameStart = (_dec = property(Label), ccclass(_class = (_class2 = class GameStart extends Component {
        ...
        addPlayer(uid, campID) {
          ...
          var trans = player.addComponent(_crd && TransformComponent === void 0 ? (_reportPossibleCrUseOfTransformComponent({
            error: Error()
          ...
          var actorStatus = player.addComponent(_crd && ActorStatusComponent === void 0 ? (_reportPossibleCrUseOfActorStatusComponent({
            error: Error()
          }), ActorStatusComponent) : ActorStatusComponent);
          var camp = player.addComponent(_crd && CampComponent === void 0 ? (_reportPossibleCrUseOfCampComponent({
            error: Error()
...
//# sourceMappingURL=b566922fb1d5ddf8446ebd881d953b58eb3254f8.js.map