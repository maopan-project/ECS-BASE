    ...
    execute: function () {
      ...
      _export("default", GameService = class GameService {
        ...
        static logicCycleThisCycle() {
          ...
          var logicThisCycle = Math.min(maxLogicNet, maxLogicTime) - world.logicCycleCount; // log('可以执行的逻辑帧是-', logicThisCycle, '最大的时间值-', maxLogicTime, '最大的网络值-', maxLogicNet);
...
//# sourceMappingURL=44a838c2dc997c2a98222c707736737abc908dd5.js.map