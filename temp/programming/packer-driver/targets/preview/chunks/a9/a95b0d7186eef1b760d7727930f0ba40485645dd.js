        ...
        onUpdate() {
          ...
          for (var i = 0; i < entities.length; i++) {
            ...
            if (entity.type === (_crd && EntityType === void 0 ? (_reportPossibleCrUseOfEntityType({
              ...
              var actor = instantiate(this.PrefabActor).getComponent(_crd && GameActor === void 0 ? (_reportPossibleCrUseOfGameActor({
                error: Error()
              }), GameActor) : GameActor);
              actor.entity = entity;
...
//# sourceMappingURL=a95b0d7186eef1b760d7727930f0ba40485645dd.js.map