        ...
        onUpdate() {
          ...
          for (var i = 0; i < entities.length; i++) {
            ...
            if (entity.type === (_crd && EntityType === void 0 ? (_reportPossibleCrUseOfEntityType({
              ...
              var actor = instantiate(this.PrefabArrow).getComponent(_crd && Actor === void 0 ? (_reportPossibleCrUseOfActor({
                error: Error()
              }), Actor) : Actor);
              actor.entity = entity;
...
//# sourceMappingURL=3f8ae35783bddacef28348f9797c337c9fc058b4.js.map