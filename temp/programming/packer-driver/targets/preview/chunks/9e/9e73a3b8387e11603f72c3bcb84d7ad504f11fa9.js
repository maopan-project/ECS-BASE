System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  function _reportPossibleCrUseOfpForAngle(extras) {
    _reporterNs.report("pForAngle", "../utils/MathUtil", _context.meta, extras);
  }
      ...
      _export("MoveSystem", MoveSystem = class MoveSystem {
        ...
        onUpdate() {
          this.world.forEach([_crd && TransformComponent === void 0 ? (_reportPossibleCrUseOfTransformComponent({
            ...
            if (transform.isMove) {
              var dir = (_crd && pForAngle === void 0 ? (_reportPossibleCrUseOfpForAngle({
                error: Error()
...
//# sourceMappingURL=9e73a3b8387e11603f72c3bcb84d7ad504f11fa9.js.map