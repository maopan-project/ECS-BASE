    ...
    execute: function () {
      ...
      _export("World", World = class World {
        ...
        cycleWithNetwork() {
          ...
          for (var _i5 = 0; _i5 < logicUpdateCount; _i5++) {
            ...
            for (var _j = (_crd && SystemType === void 0 ? (_reportPossibleCrUseOfSystemType({
              ...
              var _systems3 = this.systemInCycle[_j];
          ...
          for (var _i6 = (_crd && SystemType === void 0 ? (_reportPossibleCrUseOfSystemType({
            error: Error()
          }), SystemType) : SystemType).Render; _i6 < (_crd && SystemType === void 0 ? (_reportPossibleCrUseOfSystemType({
            error: Error()
          }), SystemType) : SystemType).End; _i6++) {
            var _systems4 = this.systemInCycle[_i6];

            if (!_systems4) {
              continue;
            }

            for (var _j2 = 0; _j2 < _systems4.length; _j2++) {
              var _system4 = _systems4[_j2];
...
//# sourceMappingURL=8da093e4ea0a435f30ec5862e6d5dd82609e4afe.js.map