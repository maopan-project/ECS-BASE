System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13", "__unresolved_14", "__unresolved_15", "__unresolved_16", "__unresolved_17"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, ActorStatusComponent, AutoDestroyComponent, BulletComponent, CampComponent, CollisionComponent, FireComponent, MoveComponent, NetworkReceiveComponent, TransformComponent, ComponentType, World, AutoDestroySystem, CollisionDetectionSystem, FireSystem, HitSystem, MoveSystem, NetworkReceiveSystem, GameService, _crd;
  ...
  function _reportPossibleCrUseOfAutoDestroySystem(extras) {
    _reporterNs.report("AutoDestroySystem", "./systems/AutoDestroySystem", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      ComponentType = _unresolved_11.ComponentType;
    }, function (_unresolved_12) {
      World = _unresolved_12.default;
    }, function (_unresolved_13) {
      AutoDestroySystem = _unresolved_13.default;
    }, function (_unresolved_14) {
      CollisionDetectionSystem = _unresolved_14.default;
    }, function (_unresolved_15) {
      FireSystem = _unresolved_15.default;
    }, function (_unresolved_16) {
      HitSystem = _unresolved_16.default;
    }, function (_unresolved_17) {
      MoveSystem = _unresolved_17.MoveSystem;
    }, function (_unresolved_18) {
      NetworkReceiveSystem = _unresolved_18.default;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("default", GameService = class GameService {
        static initWorld() {
          ...
          (_crd && AutoDestroyComponent === void 0 ? (_reportPossibleCrUseOfAutoDestroyComponent({
            error: Error()
          }), AutoDestroyComponent) : AutoDestroyComponent).prototype.type = (_crd && ComponentType === void 0 ? (_reportPossibleCrUseOfComponentType({
            error: Error()
          }), ComponentType) : ComponentType).AutoDestroy;
          ...
          world.addSystemToCycle(new (_crd && AutoDestroySystem === void 0 ? (_reportPossibleCrUseOfAutoDestroySystem({
            error: Error()
...
//# sourceMappingURL=19bb5f76e209ad3688a2dd7f74a247beba0e1f3b.js.map